  ...
  return (
    <main className="setup-page">
      ...
      <div className="setup-layout">
        <aside className="setup-steps" aria-label="Setup progress"><p className="eyebrow">Four calm steps</p><ol><li className="active"><span>1</span><p><strong>Account details</strong><small>Choose the monitoring context</small></p></li><li><span>2</span><p><strong>Confirm rules</strong><small>Review sourced definitions</small></p></li><li><span>3</span><p><strong>Connect MT5</strong><small>Pair the read-only EA</small></p></li><li><span>4</span><p><strong>Verify live data</strong><small>Check freshness and positions</small></p></li></ol><div className="setup-assurance"><span className="brand-mark"><span /></span><p><strong>No MT5 password required</strong><small>PropShield pairs to the terminal already signed in on your computer.</small></p></div></aside>
        <section className="setup-form-card">
          ...
          <form action="/pairing" method="get" className="setup-form">
            ...
            <label className="check-row"><input type="checkbox" required /><span><strong>I understand these are illustrative rules.</strong><small>PropShield will not activate protection for a real account until an authorized reviewer verifies the applicable rules and sources.</small></span></label>
