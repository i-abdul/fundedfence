  ...
  return (
    <main className="marketing-page">
      ...
      <section className="hero">
        ...
        <div className="hero-product" id="product" aria-label="Illustrative PropShield dashboard preview">
          <div className="product-window"><div className="window-bar"><span className="mini-brand"><i>PS</i> PropShield</span><span className="preview-label">ILLUSTRATIVE DATA</span><span className="window-live"><i /> Live preview</span></div><div className="preview-body"><div className="preview-heading"><span><small>ACCOUNT HEALTH</small><strong>Clear to trade within plan</strong></span><em>HEALTHY</em></div><div className="preview-health"><div className="preview-ring"><span><strong>78</strong><small>/100</small></span></div><div className="preview-buffers"><p>Closest constraint <strong>Daily loss limit</strong></p><div><span><small>DAILY BUFFER</small><strong>$4,630</strong></span><span><small>TOTAL BUFFER</small><strong>$7,630</strong></span><span><small>OPEN RISK</small><strong>$2,668</strong></span></div></div></div><div className="preview-rule-row"><span><i className="healthy" /><small>Daily drawdown</small><strong>$4,630</strong><em>92.6% available</em></span><span><i className="healthy" /><small>Total drawdown</small><strong>$7,630</strong><em>76.3% available</em></span><span><i className="neutral" /><small>Trailing floor</small><strong>$95,240</strong><em>$7,630 clear</em></span></div><div className="preview-position"><span><b>EURUSD</b><small>LONG · 0.40</small></span><span><small>RISK AT STOP</small><b>$960</b></span><span className="positive"><small>FLOATING P&amp;L</small><b>+$376</b></span><em>PROTECTED</em></div></div></div>
