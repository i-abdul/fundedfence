...
export function PairingPanel({ authenticated, signInPath }: { authenticated: boolean; signInPath: string }) {
  ...
  async function createCode() {
    ...
    try {
      const response = await fetch("/api/v1/pairing-codes", {
        ...
        body: JSON.stringify({ accountLabel: "Primary evaluation", accountSizeMinor: "10000000", currency: "USD", firmLabel: "Validation workspace", programLabel: "Evaluation sandbox" }),
      });
